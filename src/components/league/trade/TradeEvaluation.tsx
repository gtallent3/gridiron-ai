...
type TradeResult = {
  verdict: "accept" | "decline" | "balanced";
  grade: string;
  confidence: number;
  pointsChange: number;
  summary: string;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl">
                  ...
                  {result.verdict === "balanced" && "Balanced Trade"}
                </CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-background/50 rounded-lg">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-2xl font-bold ${result.pointsChange >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                {result.pointsChange >= 0 ? '+' : ''}{result.pointsChange.toFixed(1)}
              </span>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {result.positionalAnalysis.map((pos) => {
              const change = pos.after - pos.before;
